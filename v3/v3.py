from generated_commands import setup
...
'''
Как можно заметить изменений в поведении CLI не было, единственным отличием от предыдущей версии является список
типовых команд operations - он получается путем генерации команд, а не написанием вручную.

В связи с изменениями в представлении данных отдельных типовых команд в generated_comands.py структура файла конфига

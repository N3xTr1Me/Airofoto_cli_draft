...
'''
В данном файле представлены наброски типовых консольных команд для получения от пользователя данных, необходимых для
запуска функций, описанных в ТЗ:

смещение - move
поворот - rotate
обрезка по краям - cut
зашивание - patch
отбраковка по высоте - remove
наложение - mount

Все представленные функции опрашивают пользователя при помощи click.prompt для получения необходимых значений
аргументов и сохраняют полученные данные в виде словаря в объект click.context
'''
